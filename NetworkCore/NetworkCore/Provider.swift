...
public protocol ProviderProtocol {
    ...
    func request<Model: Decodable>(_ apiMethod: API, completion: @escaping CompletionWithResult<Model>)
    func cancel()
}
...
open class Provider<API: INetworkAPI>: ProviderProtocol {
    ...
    open func request(_ apiMethod: API, completion: @escaping Completion) {
    ...
    open func request<Model: Decodable>(_ apiMethod: API, completion: @escaping CompletionWithResult<Model>) {
        guard let request = try? RequestBuilder.build(from: apiMethod) else {
            completion(.failure(.encodingFailed))
            return
        }
